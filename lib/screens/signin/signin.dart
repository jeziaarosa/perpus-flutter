...
import 'package:perpus1/main.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: Container(
          ...
          padding: const EdgeInsets.only(top: 175), // Reduce the top padding to minimize the gap
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              _header(context),
              const SizedBox(height: 20), // Adjust the height to reduce the gap
              _inputField(context),
              const SizedBox(height: 10), // Adjust the height to reduce the gap
              _signup(context),
            ],
          ),
        ),
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: const Color.fromARGB(255, 221, 230, 237),
              fontSize: 30,
          ...
          Align(
            ...
            child: TextButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontFamily: GoogleFonts.poppins().fontFamily,
                  color: const Color.fromARGB(255, 157, 178, 191),
                ),
              ),
            ),
          ),
